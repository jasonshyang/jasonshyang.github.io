...
description: Working through the mathematics of concentrated liquidity and the relationship between real and virtual reserves.
date: 2025-01-29
tags: [dex, uniswap]
kind: DeFi
math: true
...
![Figure 2 from the Uniswap v3 whitepaper: the real reserves curve shifted from the virtual reserves curve](../../assets/posts/uniswapv3.png)
